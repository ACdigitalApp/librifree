-- Add views column
ALTER TABLE public.books ADD COLUMN IF NOT EXISTS views integer NOT NULL DEFAULT 0;

-- Create increment function
CREATE OR REPLACE FUNCTION public.increment_book_views(book_slug text)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
...
AS $$
BEGIN
  UPDATE books SET views = views + 1 WHERE slug = book_slug;
END;
$$;
