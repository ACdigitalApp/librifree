  ...
  if (!book) {
    return (
      <div className="min-h-svh flex flex-col items-center justify-center text-center px-6">
        <h1 className="font-display text-2xl font-medium text-foreground">{t("bookNotFound")}</h1>
    ...
    <main className="px-6 py-12 sm:py-16">
      <article className="mx-auto max-w-[65ch]">
        <div className="flex items-center justify-between mb-12">
          <Link to="/biblioteca" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors font-body">
